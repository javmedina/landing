...
h3 {text-align: center;font-family: 'Holtwood One SC', serif; font-size: 3rem;color:#8efd81; line-height: 3rem;}
h4 {text-align: center; font-family:'Roboto Slab', serif; font-size: 0.8rem; letter-spacing: 0.20rem;color: white;}
h5 {text-align: center;font-family: 'Holtwood One SC', serif; font-size: 1rem;color: white;line-height: 0.9rem;letter-spacing: 0.15rem;}
h6 {text-align: center;font-family: 'Holtwood One SC', serif; font-size: 1rem;color: white;line-height: 0.9rem;letter-spacing: 0.15rem;}
